...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "Something went wrong! Couldn't save the appointment"));
  ...
  it("shows the delete error when failing to delete an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "Something went wrong! Couldn't delete the appointment"));
